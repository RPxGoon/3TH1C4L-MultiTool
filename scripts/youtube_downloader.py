...
def youtube_downloader():
    ...
    def fetch_video_details():
        try:
            link = url_entry.get()
            yt = YouTube(link)
            yt.check_availability()  # Check for availabilit
    ...
    # Input Field for URL (Kinda Looks Like Shit But its Temporary)
    ...
    # Fetch Details Button (same here, kinda looks like shit but ill fix it)
